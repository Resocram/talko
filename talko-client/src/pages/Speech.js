...
function Speech() {
	return (
		<div> 
            ...
            <form >
                <TextField multiline placeholder="Enter your speech here..." style={{backgroundColor: "#1A2930", width: "81%", border: "4px solid #F2C407", height: "230px", 
                color: "#F2C407", fontSize: "35px", marginTop: "20px", paddingLeft: "40px", paddingTop: "20px",
                borderRadius: "45px", marginLeft: "8%", marginRight: "8%"}}/>
            </form>
